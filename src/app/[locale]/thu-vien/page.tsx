            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b-2 border-ink bg-ink text-paper">
                  <th className="px-4 py-3 font-sans text-xs font-bold uppercase tracking-widest">{p.documentName}</th>
                  <th className="px-4 py-3 font-sans text-xs font-bold uppercase tracking-widest">{p.type}</th>
                  <th className="px-4 py-3 font-sans text-xs font-bold uppercase tracking-widest">{p.updated}</th>
                </tr>
              </thead>
              <tbody>
                {TAI_LIEU.map((t) => (
