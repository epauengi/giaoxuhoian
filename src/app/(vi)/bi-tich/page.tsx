...
export default function BiTichPage() {
  return (
    <>
      ...
      <section id="chung-nhan" className="border-b border-ink">
        <div className="mx-auto max-w-screen-xl px-4 py-12">
          <SectionHeader label="Thủ tục" title="Xin chứng nhận Bí tích" />
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            <div className="border border-ink p-6 lg:col-span-5">
              <p className="font-sans text-xs font-bold uppercase tracking-widest">Đầu mối</p>
